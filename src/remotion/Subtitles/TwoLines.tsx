...
// Font type mapping
const FONT_TYPE_MAP: Record<string, { fontSize: number; fontWeight: number; fontFamily: string }> = {
    'bold': { fontSize: 120, fontWeight: 800, fontFamily: bebas.fontFamily },
    'thin': { fontSize: 60, fontWeight: 100, fontFamily: inter.fontFamily },
...
export const TwoLines: React.FC<{ group: SubtitleGroup }> = ({ group }) => {
