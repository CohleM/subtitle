...
function PricingSkeleton() {
    return (
        <div className="max-w-screen-lg mx-auto px-6 py-20">
            <div className="text-center mb-12">
                <div className="h-4 w-16 bg-gray-200 rounded mx-auto mb-2 animate-pulse" />
                <div className="h-3 w-32 bg-gray-200 rounded mx-auto animate-pulse" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="flex flex-col p-6 rounded-2xl border border-gray-100 bg-white">
                        <div className="h-5 w-20 bg-gray-200 rounded mb-4 animate-pulse" />
                        <div className="h-8 w-16 bg-gray-200 rounded mb-6 animate-pulse" />
